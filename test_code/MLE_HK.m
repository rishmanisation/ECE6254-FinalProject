function [phat,image_thresh]=MLE_HK( top, left, right, bottom, target)
...
image_thresh = [(r*c)-sum(image_thresh_top(:)),(r*c)-sum(image_thresh_bottom(:)),(r*c)-sum(image_thresh_right(:)),(r*c)-sum(image_thresh_left(:))];
% 
