...
%------------------------------------------------------------------------%
% Generate the test targets (USED FOR INITIAL DEVELOPMENT)
%------------------------------------------------------------------------%
% image=zeros(256,256);
...
%------------------------------------------------------------------------%
% Normalize the image (USED FOR INITIAL DEVELOPMENT)
%------------------------------------------------------------------------%
% target=target/255;
% figure('Name','Original Image','NumberTitle','off'); imshow(image);

%------------------------------------------------------------------------%
% Add some noise (USED FOR INITIAL DEVELOPMENT)
%------------------------------------------------------------------------%
% [r, c]   = size(target);
...
% If the number is higher, it means not a background
image_thresh_top     = (prob_top    < prob_target); 
